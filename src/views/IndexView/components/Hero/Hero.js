...
const Hero = ({ themeMode = 'light', className, ...rest }) => {
  ...
  const subtitle = 'We are a professional IT service advisor that can assist with business services ranging from remote computer management and set up to migrating your data into the cloud.';
