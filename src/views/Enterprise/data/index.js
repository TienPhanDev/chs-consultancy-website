...
export const features = [
  {
    label: 'How to fuel business growth',
    title: 'More Revenue',
    description:
    'Add new recurring revenue streams to existing managed service networks.',
    illustration: 'https://assets.maccarianagency.com/the-front/illustrations/brand-platform.svg',
  },
  {
    label: 'RESPONSIVE Mobile Compatible Platform',
    title: 'Additional Device Endpoints',
    description:
      'Introduce your brand-new mobile friendly website to your clients. Seamlessly integrates with other applications and allows for increased billing.',
    illustration: 'https://assets.maccarianagency.com/the-front/illustrations/mobiles.svg',
  },
  {
    label: 'Remote client management',
    title: 'Customizable Business Tools',
    description:
      'Give sub-users access to a simplified dashboard with permission levels to offer remote management and real-time analytics.',
  ...
  },
  {
    ...
    description:
      'Build, customize any integration your customers want and add in your social media profiles!',
